...
//
//        switch (authMethod) { // auth method
//            case 0:
//                break; // no auth
//            case 2:
//                System.out.println("Trying Auth with " + client.proxy.username + ":" + client.proxy.password);
//                System.out.println("Username #chars:" + client.proxy.username.length() + " Bytest len:" + client.proxy.username.getBytes().length);
//                System.out.println("pass #chars:" + client.proxy.password.length() + " Bytest len:" + client.proxy.password.getBytes().length);
//
...
//
//                int version = in.read();
//                System.out.println("response version(should be 1): " + version);
//                byte status = in.readByte();
//                System.out.println("Login status: " + status);
//                if (status == 0) // Successful login, continue
//                {
...
//
//        System.out.println("Writing the SOCKS5 address for ipv4(probably");
...
////        byte serverReplyVersion = in.readByte();
////        System.out.println("System version: " + serverReplyVersion);
////        if (serverReplyVersion != 0x05) // socks version (again)
////        {
////            throw new IOException("Proxy server dun goofed");
////        }
////
////        byte commandCode = in.readByte();
////        System.out.println("Command code: " + Byte.toString(commandCode));
////        in.readByte(); // reserved
////        byte boundedAddress = in.readByte(); // bounded address
////        System.out.println("boundedAddress: " + Byte.toString(boundedAddress));
