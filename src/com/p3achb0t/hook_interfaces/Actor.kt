...
interface Actor : Renderable {
    ...
    fun get_hitCycles(): ArrayList<Int>

    fun get_hitDamages(): ArrayList<Int>
    fun get_hitTypes(): ArrayList<Int>
    fun get_interacting(): Int
    fun get_localX(): Int
    fun get_localY(): Int
    fun get_message(): ArrayList<Int>
    fun get_orientation(): Int
    fun get_queueSize(): Int
    //    fun get_queueTraversed(): ArrayList<Byte>
    fun get_queueX(): ArrayList<Int>

    fun get_queueY(): ArrayList<Int>
