...
//			val boundsWidth = if(boundsIndex > 0 && (getParentIndex(widget).parentID.toInt() == -1)) MainApplet.clientData.getWidgetWidths()[boundsIndex] else widget.getWidth()
//			val boundsHeight = if(boundsIndex > 0 && (getParentIndex(widget).parentID.toInt() == -1)) MainApplet.clientData.getWidgetHeights()[boundsIndex] else widget.getHeight()
