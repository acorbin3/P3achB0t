...
fun drawClientDebugText(g: Graphics, ctx: Context) {
    ...
    if (true) {
        ...
        g.color = Color.white
        debugText.add(DebugText("get__c_gj      : ${ctx.client.get__c_gj()}"))
        debugText.add(DebugText("get__e_l       : ${ctx.client.get__e_l()}"))
        debugText.add(DebugText("get__e_b       : ${ctx.client.get__e_b()}"))
        debugText.add(DebugText("get__q_h       : ${ctx.client.get__q_h()}"))
        debugText.add(DebugText("get__x_gw      : ${ctx.client.get__x_gw()}"))
        debugText.add(DebugText("get__u_go      : ${ctx.client.get__u_go()}"))
        debugText.add(DebugText("get__u_rq      : ${ctx.client.get__u_rq()}"))
        debugText.add(DebugText("get__j_l       : ${ctx.client.get__j_l()}"))
        debugText.add(DebugText("get__j_rh      : ${ctx.client.get__j_rh()}"))
        debugText.add(DebugText("get__ay_sx     : ${ctx.client.get__ay_sx()}"))
        debugText.add(DebugText("get__at_nt     : ${ctx.client.get__at_nt()}"))
        debugText.add(DebugText("get__ax_au     : ${ctx.client.get__ax_au()}"))
        debugText.add(DebugText("get__aw_gf     : ${ctx.client.get__aw_gf()}"))
        debugText.add(DebugText("get__aw_z      : ${ctx.client.get__aw_z()}"))
        debugText.add(DebugText("get__ai_qw     : ${ctx.client.get__ai_qw()}"))
        debugText.add(DebugText("get__av_rk     : ${ctx.client.get__av_rk()}"))
        debugText.add(DebugText("get__bj_q      : ${ctx.client.get__bj_q()}"))
        debugText.add(DebugText("get__bi_cc     : ${ctx.client.get__bi_cc()}"))
        debugText.add(DebugText("get__bi_ce     : ${ctx.client.get__bi_ce()}"))
        debugText.add(DebugText("get__bi_cg     : ${ctx.client.get__bi_cg()}"))
        debugText.add(DebugText("get__bi_co     : ${ctx.client.get__bi_co()}"))
        debugText.add(DebugText("get__bi_cu     : ${ctx.client.get__bi_cu()}"))
        debugText.add(DebugText("get__bi_cx     : ${ctx.client.get__bi_cx()}"))
        debugText.add(DebugText("get__bp_q      : ${ctx.client.get__bp_q()}"))
        debugText.add(DebugText("get__bq_ao     : ${ctx.client.get__bq_ao()}"))
        debugText.add(DebugText("get__bx_v      : ${ctx.client.get__bx_v()}"))
        debugText.add(DebugText("get__bw_i      : ${ctx.client.get__bw_i()}"))
        debugText.add(DebugText("get__bt_d      : ${ctx.client.get__bt_d()}"))
        debugText.add(DebugText("get__bt_l      : ${ctx.client.get__bt_l()}"))
        debugText.add(DebugText("get__bt_q      : ${ctx.client.get__bt_q()}"))
        debugText.add(DebugText("get__bl_ad     : ${ctx.client.get__bl_ad()}"))
        debugText.add(DebugText("get__bh_j      : ${ctx.client.get__bh_j()}"))
        debugText.add(DebugText("get__bh_o      : ${ctx.client.get__bh_o()}"))
        debugText.add(DebugText("get__ba_iv     : ${ctx.client.get__ba_iv()}"))
        debugText.add(DebugText("get__bu_ny     : ${ctx.client.get__bu_ny()}"))
        debugText.add(DebugText("get__client_iy : ${ctx.client.get__client_iy()}"))
        debugText.add(DebugText("get__client_sw : ${ctx.client.get__client_sw()}"))
        debugText.add(DebugText("get__client_bz : ${ctx.client.get__client_bz()}"))
        debugText.add(DebugText("get__client_ci : ${ctx.client.get__client_ci()}"))
        ...
        debugText.add(DebugText("get__client_dj : ${ctx.client.get__client_dj()}"))
        debugText.add(DebugText("get__client_ec : ${ctx.client.get__client_ec()}"))
        ...
        debugText.add(DebugText("get__client_jk : ${ctx.client.get__client_jk()}"))
        ...
        debugText.add(DebugText("get__client_lp : ${ctx.client.get__client_lp()}"))
        debugText.add(DebugText("get__client_lx : ${ctx.client.get__client_lx()}"))
        debugText.add(DebugText("get__client_ly : ${ctx.client.get__client_ly()}"))
        ...
        debugText.add(DebugText("get__client_mm : ${ctx.client.get__client_mm()}"))
        ...
        debugText.add(DebugText("get__client_pf : ${ctx.client.get__client_pf()}"))
        ...
        debugText.add(DebugText("get__client_sn : ${ctx.client.get__client_sn()}"))
        debugText.add(DebugText("get__client_sp : ${ctx.client.get__client_sp()}"))
        debugText.add(DebugText("get__cd_id     : ${ctx.client.get__cd_id()}"))
        debugText.add(DebugText("get__cq_z      : ${ctx.client.get__cq_z()}"))
        debugText.add(DebugText("get__cf_n      : ${ctx.client.get__cf_n()}"))
        debugText.add(DebugText("get__cn_ea     : ${ctx.client.get__cn_ea()}"))
        debugText.add(DebugText("get__cn_p      : ${ctx.client.get__cn_p()}"))
        debugText.add(DebugText("get__cj_t      : ${ctx.client.get__cj_t()}"))
        debugText.add(DebugText("get__ca_si     : ${ctx.client.get__ca_si()}"))
        debugText.add(DebugText("get__cy_ae     : ${ctx.client.get__cy_ae()}"))
        debugText.add(DebugText("get__cy_al     : ${ctx.client.get__cy_al()}"))
        debugText.add(DebugText("get__cy_at     : ${ctx.client.get__cy_at()}"))
        debugText.add(DebugText("get__cy_bf     : ${ctx.client.get__cy_bf()}"))
        debugText.add(DebugText("get__cy_bg     : ${ctx.client.get__cy_bg()}"))
        debugText.add(DebugText("get__cy_bi     : ${ctx.client.get__cy_bi()}"))
        debugText.add(DebugText("get__cy_bm     : ${ctx.client.get__cy_bm()}"))
        debugText.add(DebugText("get__cy_d      : ${ctx.client.get__cy_d()}"))
        debugText.add(DebugText("get__cy_u      : ${ctx.client.get__cy_u()}"))
        debugText.add(DebugText("get__cx_a      : ${ctx.client.get__cx_a()}"))
        debugText.add(DebugText("get__cx_e      : ${ctx.client.get__cx_e()}"))
        debugText.add(DebugText("get__cw_a      : ${ctx.client.get__cw_a()}"))
        debugText.add(DebugText("get__dq_eu     : ${ctx.client.get__dq_eu()}"))
        debugText.add(DebugText("get__dq_rl     : ${ctx.client.get__dq_rl()}"))
        debugText.add(DebugText("get__de_q      : ${ctx.client.get__de_q()}"))
        debugText.add(DebugText("get__df_bl     : ${ctx.client.get__df_bl()}"))
        debugText.add(DebugText("get__ek_aa     : ${ctx.client.get__ek_aa()}"))
        debugText.add(DebugText("get__eb_e      : ${ctx.client.get__eb_e()}"))
        debugText.add(DebugText("get__eb_q      : ${ctx.client.get__eb_q()}"))
        debugText.add(DebugText("get__eb_y      : ${ctx.client.get__eb_y()}"))
        debugText.add(DebugText("get__eh_e      : ${ctx.client.get__eh_e()}"))
        debugText.add(DebugText("get__ev_rb     : ${ctx.client.get__ev_rb()}"))
        debugText.add(DebugText("get__eq_az     : ${ctx.client.get__eq_az()}"))
        debugText.add(DebugText("get__eq_k      : ${ctx.client.get__eq_k()}"))
        debugText.add(DebugText("get__ey_ib     : ${ctx.client.get__ey_ib()}"))
        debugText.add(DebugText("get__eu_g      : ${ctx.client.get__eu_g()}"))
        debugText.add(DebugText("get__fc_el     : ${ctx.client.get__fc_el()}"))
        debugText.add(DebugText("get__fz_ew     : ${ctx.client.get__fz_ew()}"))
        debugText.add(DebugText("get__fp_i      : ${ctx.client.get__fp_i()}"))
        debugText.add(DebugText("get__fp_rg     : ${ctx.client.get__fp_rg()}"))
        debugText.add(DebugText("get__fp_rv     : ${ctx.client.get__fp_rv()}"))
        debugText.add(DebugText("get__fm_rd     : ${ctx.client.get__fm_rd()}"))
        debugText.add(DebugText("get__gl_h      : ${ctx.client.get__gl_h()}"))
        debugText.add(DebugText("get__gl_y      : ${ctx.client.get__gl_y()}"))
        debugText.add(DebugText("get__gk_h      : ${ctx.client.get__gk_h()}"))
        debugText.add(DebugText("get__gw_cz     : ${ctx.client.get__gw_cz()}"))
        debugText.add(DebugText("get__ge_y      : ${ctx.client.get__ge_y()}"))
        debugText.add(DebugText("get__gg_mf     : ${ctx.client.get__gg_mf()}"))
        debugText.add(DebugText("get__he_s      : ${ctx.client.get__he_s()}"))
        debugText.add(DebugText("get__hg_c      : ${ctx.client.get__hg_c()}"))
        debugText.add(DebugText("get__hx_ri     : ${ctx.client.get__hx_ri()}"))
        debugText.add(DebugText("get__ig_f      : ${ctx.client.get__ig_f()}"))
        debugText.add(DebugText("get__if_d      : ${ctx.client.get__if_d()}"))
        debugText.add(DebugText("get__ii_v      : ${ctx.client.get__ii_v()}"))
        debugText.add(DebugText("get__ii_x      : ${ctx.client.get__ii_x()}"))
        debugText.add(DebugText("get__it_d      : ${ctx.client.get__it_d()}"))
        debugText.add(DebugText("get__lz_d      : ${ctx.client.get__lz_d()}"))
        debugText.add(DebugText("get__lz_n      : ${ctx.client.get__lz_n()}"))
        debugText.add(DebugText("get__lz_v      : ${ctx.client.get__lz_v()}"))
