package com.p3achb0t.api.cache.format;
...
public interface Cache {
    ...
    static CompletableFuture<IndexMaster> buildIndexMaster(Cache cache, int archive, IndexMaster im) {
    ...
    static CompletableFuture<Void> updateArchive(
            Cache src,
            MutableCache dst,
            int archive,
            IndexMaster sim,
    ...
    static CompletableFuture<Void> updateArchive0(
            Cache src,
            MutableCache dst,
            int archive,
            IndexMaster sim,
