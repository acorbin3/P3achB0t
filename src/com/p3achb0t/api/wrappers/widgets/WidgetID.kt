...
class WidgetID {
    companion object {
        ...
        const val THEATRE_OF_BLOOD_GROUP_ID = 23
    ...
    internal object BarbarianAssault {
        const val CORRECT_STYLE = 3
        const val CURRENT_WAVE_WIDGET = 4
        const val CURRENT_WAVE = 5
        const val CALL_WIDGET = 6
        const val CALL_TEXT = 7
    ...
    internal object StandardSpellBook {
        const val LUMBRIDGE_HOME_TELEPORT = 4
    }

    internal object AncientSpellBook {
        const val EDGEVILLE_HOME_TELEPORT = 98
    }

    internal object LunarSpellBook {
        const val LUNAR_HOME_TELEPORT = 99
    }

    internal object ArceuusSpellBook {
        const val ARCEUUS_HOME_TELEPORT = 143
    }

    internal object Pvp {
        const val BOUNTY_HUNTER_INFO = 18
        const val KILLDEATH_RATIO = 15
        const val SKULL_CONTAINER = 61
        const val SAFE_ZONE = 63
        const val WILDERNESS_LEVEL = 66 // this can also be the Deadman Mode "Protection" text
    }
